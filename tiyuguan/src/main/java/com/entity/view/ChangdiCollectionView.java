...
public class ChangdiCollectionView extends ChangdiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String changdiCollectionValue;
	...
	public ChangdiCollectionView(ChangdiCollectionEntity changdiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, changdiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChangdiCollectionValue() {
				return changdiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChangdiCollectionValue(String changdiCollectionValue) {
				this.changdiCollectionValue = changdiCollectionValue;
			}
